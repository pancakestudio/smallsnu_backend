...
urlpatterns = [
    ...
    path('post/<int:postId>/like/', views.building_post_like),
    path('post/<int:postId>/comment/', views.building_post_comment),
    path('post/', views.post_list),
    path('comment/<int:commentId>/', views.comment_detail),
    path('comment/<int:commentId>/like/', views.comment_like),
